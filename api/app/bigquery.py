...
def list_tenders(
    ...
    # Prefix with 'base.' when doing VECTOR_SEARCH, otherwise use bare column names
    col_prefix = "base." if q else ""
    ...
    if q:
        # Case A: Semantic AI Vector Search
        ...
        # Over-fetch top_k so SQL WHERE filters have records to filter on
        top_k = max(limit + offset, 100)
        ...
        # Case B: Standard browse / no search query term
